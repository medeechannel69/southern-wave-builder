...
const faqLd = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "MedeeWeb มีแพ็กเกจอะไรบ้าง?", acceptedAnswer: { "@type": "Answer", text: "มี 3 แพ็กเกจหลัก: Starter 5,000 บาท (1 หน้า, ส่ง 7 วัน), Business 9,000 บาท (5 หน้า + SEO, ส่ง 14 วัน), Pro 15,000 บาท (10 หน้า + SEO ครบ + Analytics, ส่ง 21 วัน)" } },
    { "@type": "Question", name: "ใช้เวลาทำเว็บไซต์นานเท่าไหร่?", acceptedAnswer: { "@type": "Answer", text: "ขึ้นอยู่กับแพ็กเกจ: Starter 7 วัน, Business 14 วัน, Pro 21 วัน นับจากวันที่ลูกค้าส่งข้อมูลครบถ้วน" } },
